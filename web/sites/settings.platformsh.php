...
if (
  ...
  && class_exists(ClientFactory::class)
) {
...
// OAuth keys setup.
$config['simple_oauth.settings']['public_key'] = $settings['file_private_path'] . '/keys/oauth.pub';
$config['simple_oauth.settings']['private_key'] = $settings['file_private_path'] . '/keys/oauth.key';
